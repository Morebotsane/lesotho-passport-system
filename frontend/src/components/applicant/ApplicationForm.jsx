...
export default function ApplicationForm() {
  ...
  const handleChange = (e) => {
    ...
    const error = getFieldValidationError(name, value, formData);
  ...
  const handleFileChange = (e) => {
    ...
    if (files && files[0]) {
      ...
      const error = getFieldValidationError(name, file, formData);
      setErrors((prev) => ({ ...prev, [name]: error }));
    }
  };

  const validateStep = (step) => {
    const newErrors = validateApplicationStep(step, formData);
    setErrors(newErrors);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const applicationData = {
        ...
        previous_passport_number:
          formData.previous_passport_number || undefined,
      ...
      if (formData.photo || formData.id_document) {
        ...
        try {
          const uploadResponse = await applicationsApi.uploadDocuments(
            response.id,
            formDataFiles
          );
          ...
          toast.error(
            "Documents failed to upload, but application was created"
          );
        }
      } else {
      ...
      navigate(
        `/applicant/appointments/book-submission?application=${response.id}`
      );
    } catch (error) {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`input-field ${
                    errors.place_of_birth ? "border-red-500" : ""
                  }`}
                />
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className={`input-field ${
                    errors.residential_address ? "border-red-500" : ""
                  }`}
                />
            ...
            <div className="md:col-span-2">
              ...
              <select
                ...
                className={`input-field ${
                  errors.submission_location_id ? "border-red-500" : ""
                }`}
              >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`input-field ${
                  errors.reason_for_issuance ? "border-red-500" : ""
                }`}
              >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleFileChange}
                className={`input-field ${
                  errors.id_document ? "border-red-500" : ""
                }`}
              />
              {errors.id_document && (
                <p className="text-red-500 text-sm mt-1">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="card bg-gray-50">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium capitalize">
                      {formData.reason_for_issuance.replace("_", " ")}
                    </p>
                  </div>
              ...
              <div className="card bg-gray-50">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p className="text-green-600">
                    ID Document: {formData.id_document?.name}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                Before submitting: Please ensure all information is correct. You
                will receive SMS notifications about your application status.
              </p>
            </div>
          </div>
        )}
